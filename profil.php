        ...
        <div class="photo">
          ...
          <?php
              ...
              while ($senior = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo " <div class='infos'> <div class='title-infos'> <h2> Nom </h2> <input type='text' name='nom' value='$nom' readonly='readonly' /> </div> </div>";
                echo " <div class='infos'> <div class='title-infos'> <h2> Prenom </h2> <input type='text' name='prenom' value='$prenom' readonly='readonly' /> </div> </div>";
                echo " <div class='infos'> <div class='title-infos'> <h2> Pseudo </h2> <input type='text' name='pseudo' value='$pseudo' readonly='readonly' /> </div> </div>";
                echo " <div class='infos'> <div class='title-infos'> <h2> Telephone </h2> <input type='text' name='tel' value='$tel' readonly='readonly' /> </div> </div>";
                echo " <div class='infos'> <div class='title-infos'> <h2> Date de Naissance </h2> <input type='text' name='date_n' value='$date_n' readonly='readonly' /> </div> </div>";
              }
